...
from .enums import (
    ...
    WorkflowType, ExecutionStrategy, FrameworkCapability, SessionType
)
...
class WorkflowConfig(BaseModel):
    ...
    pipeline_stages: List[Dict[str, Any]] = Field(default_factory=list, description="Pipeline stages")
...
class AgentExecutionResult(BaseModel):
    ...
    tool_calls: List["ToolCallResult"] = Field(default_factory=list, description="Tool call results")
    kb_queries: List["KnowledgeBaseQueryResult"] = Field(default_factory=list, description="KB query results")
